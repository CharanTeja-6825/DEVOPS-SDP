  ...
  return (
    <div className="card rounded-3xl p-8 animate-fadeIn">
      <div className="text-center mb-8">
        <div className="w-20 h-20 mx-auto bg-accent rounded-full flex items-center justify-center mb-4 shadow-lg">
          <span className="text-3xl">✨</span>
        </div>
        <h2 className="text-3xl font-bold mb-2">Create Account</h2>
        <p className="text-light/70">Join us to start managing your budget</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <button
          type="submit"
          disabled={loading}
          className="btn btn-accent w-full disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
        >
